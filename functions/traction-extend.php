	...
	if (!class_exists( 'Traction' )) {
		class Traction extends JestroCore {
			...
			function Traction () {
				...
				*/
				$this->options = array(
					...
					array(
						"name" => __( 'Custom Logo Image <span>insert your custom logo image in the header</span>', 'traction' ),
						"type" => "subhead"),

					array(
						"name" => __( 'Enable custom logo image', 'traction' ),
					...
					array(
						"name" => __( 'Logo image file name', 'traction' ),
						"id" => $this->shortname."_logo_img",
						"pro" => "true",
						"desc" => __( sprintf( __( 'Choose an image from your computer or specify any image file name you have uploaded to the %s directory.' ), '<code>' . STYLESHEETPATH . '/images/</code>' ), 'traction' ),
						"std" => '',
						"type" => "text"),

					array(
						"name" => __( 'Logo image <code>&lt;alt&gt;</code> tag', 'traction' ),
					...
					array(
						"name" => __( 'Display tagline', 'traction' ),
					...
					array(
						"name" => __( 'Featured Slider <span>take control of your featured slider.</span>', 'traction' ),
						"notice" => __( 'The featured slider shows demo posts only in the free trial version of Traction.', 'traction' ),
						"type" => "subhead"),

					array(
						"name" => __( 'Enable featured slider', 'traction' ),
					...
					array(
						"name" => __( 'Autostart delay', 'traction' ),
					...
					array(
						"name" => __( 'Slide animation speed', 'traction' ),
					...
					array(
						"name" => __( 'Color Scheme <span>choose your color scheme</span>', 'traction' ),
						"type" => "subhead"),

					array(
						"name" => __( 'Color scheme', 'traction' ),
						...
						"type" => "select",
						"options" => array(
							"default" => __( 'Default (blue)', 'traction' ),
							"red" => __( 'Red', 'traction' ),
							"green" => __( 'Green', 'traction' ))),
					...
					array(
						"name" => __( 'Exclude specific pages', 'traction' ),
					...
					array(
						"name" => __( 'Exclude specific categories', 'traction' ),
					...
					array(
						"name" => __( 'Hide home navigation menu item', 'traction' ),
					...
					array(
						"name" => __( 'Enable top banner ad', 'traction' ),
					...
					array(
						"name" => __( 'Top banner ad file name', 'traction' ),
						"id" => $this->shortname."_banner_img",
						"pro" => "true",
						"desc" => __( sprintf( __( 'Upload your image to the %s directory.' ), '<code>' . STYLESHEETPATH . '/images/ads/</code>' ), 'traction' ),
						"std" => '',
						"type" => "text"),

					array(
						"name" => __( 'Top banner ad link', 'traction' ),
					...
					array(
						"name" => __( 'Top banner alt tag', 'traction' ),
					...
					array(
						"name" => __( 'Enable Twitter', 'traction' ),
					...
					array(
						"name" => __( 'Twitter <span>show your latest tweets in the sidebar</span>', 'traction' ),
						"type" => "subhead"),

					array(
						"name" => __( 'Twitter sidebar updates', 'traction' ),
					...
					array(
						"name" => __( 'Number of updates', 'traction' ),
					...
					array(
						"name" => __('Disable About', 'traction'),
						"id" => $this->shortname."_about_state",
						"pro" => "true",
						"desc" => __('Check this box to disable the About section and enable the footer widget instead.', 'traction'),
						"std" => '',
						"type" => "checkbox"),
			...
			*/
			...
			function bannerUrl() {
				return wp_filter_post_kses(get_option($this->shortname.'_banner_link' ));
			}
			function bannerAlt() {
			...
			function adboxUrl1() {
				return wp_filter_post_kses(get_option($this->shortname.'_adlink_1' ));
			}
			function adboxAlt1() {
			...
			function adboxUrl2() {
				return wp_filter_post_kses(get_option($this->shortname.'_adlink_2' ));
			}
			function adboxAlt2() {
			...
			function facebook() {
				return wp_filter_post_kses(get_option($this->shortname.'_facebook' ));
			}
			...
			/* TWITTER FUNCTIONS */
			function twitter() {
				return wp_filter_post_kses(get_option($this->shortname.'_twitter' ));
			}
			function twitterState() {
				return wp_filter_post_kses(get_option($this->shortname.'_twitter_state' ));
			}
			function twitterUpdates() {
				return wp_filter_post_kses(get_option($this->shortname.'_twitter_updates' ));
			}
